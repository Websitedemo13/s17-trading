...
const EnhancedBlogPostDetail = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="blog-dialog-content max-w-6xl p-0">
        <VisuallyHidden>
          <DialogTitle>
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="blog-dialog-tabs flex-1">
              ...
              <TabsContent value="content" className="blog-dialog-tabs-content">
              ...
              <TabsContent value="resources" className="mt-0 flex-1 overflow-y-auto">
                <ScrollArea className="h-full">
                  <div className="p-6 space-y-6">
                    <div>
                      <h3 className="text-lg font-semibold mb-4">
