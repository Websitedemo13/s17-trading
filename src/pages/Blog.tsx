    ...
    try {
      ...
      const mockCategories: BlogCategory[] = [
        ...
        { 
          ...
          slug: 'vietnam-stocks', 
          description: 'Phân tích và tin tức thị trường chứng kho��n Việt Nam', 
          postCount: 28, 
          color: 'bg-green-500',
          icon: TrendingUp
        },
...
- **L��m phát**: Bitcoin được xem như hedge against inflation
...
| Metric | VIC | Novaland (NVL) | Vinhomes (VHM) |
|--------|-----|----------------|----------------|
| P/E | 12.5x | 8.9x | 15.2x |
| ROE | 18.5% | 12.3% | 22.1% |
| Debt/Equity | 0.45x | 0.78x | 0.35x |
| Dividend Yield | 4.2% | 3.8% | 5.1% |
...
### Vietnam Tax Framework
- **Capital Gains**: 20% on crypto profits
- **DeFi Yields**: Treated as income (progressive rates)
- **Record Keeping**: Track all transactions
- **Reporting**: Annual tax declaration required

### Tax Optimization
- **Long-term Holding**: Reduced rates for 1+ year holds
- **Loss Harvesting**: Offset gains with losses
- **Professional Advice**: Consult crypto tax specialists

## Platform Comparison

| Protocol | TVL | Base APY | Token Rewards | Risk Level |
|----------|-----|----------|---------------|------------|
| Uniswap V3 | $4.2B | 5-15% | None | Low |
| Aave | $6.8B | 3-12% | AAVE | Low |
| Curve | $2.1B | 8-25% | CRV + partner tokens | Low-Med |
| Convex | $1.8B | 15-40% | CVX + CRV | Medium |
| Yearn | $650M | 10-30% | Auto-compound | Medium |
...
### Emerging Trends
1. **Real World Assets (RWA)**: Tokenized real estate, bonds
2. **Cross-Chain Yield**: Multi-chain farming strategies  
3. **AI-Powered Optimization**: Automated yield optimization
4. **Institutional DeFi**: Traditional finance integration

### Regulation Impact
- **Compliance Requirements**: KYC/AML for large protocols
- **Tax Reporting**: Automated reporting tools
- **Investor Protection**: Insurance products, guarantees
...
### Phase 4: Advanced Psychology (Month 4+)
...
- Visualize perfect trade execution
...
**TradingView Alerts**: Remove need for constant chart watching
**Position Size Calculators**: Automate risk management calculations
**Trading Journals**: Edgewonk, TradeBench for detailed analysis
**Meditation Apps**: Headspace, Calm for stress management

### 2. Professional Support

**Trading Psychology Coach**: Specialized coaches for trader mindset
**Therapist**: For underlying psychological issues
**Trading Groups**: Peer support and accountability
**Mentorship**: Learn from experienced profitable traders
...
**Discipline Metrics**:
- % trades following plan: Target >95%
- Rule violations per month: Target <5
- Emotional trades per month: Target 0
...
**Behavioral Metrics**:
- Time spent on analysis vs execution
- Frequency of strategy changes
- Adherence to trading schedule
...
### Emerging Markets
**Tightening Cycle Impact**:
- **Capital Outflows**: Search for higher USD yields
- **Currency Weakness**: Imported inflation pressure
- **Debt Servicing**: Higher costs for USD-denominated debt

**Vulnerable Countries** (High USD debt/GDP):
- Turkey, Argentina, South Africa
- **Resilient Countries**: Strong reserves, current account surplus

### Developed Markets
**European Central Bank**: Following Fed with lag
**Bank of Japan**: Still accommodative, USD/JPY pressure
**Bank of Canada**: Closely correlated with Fed policy

### China Impact
**Monetary Policy Divergence**: PBOC easing vs Fed tightening
**Trade Implications**: Strong USD affects export competitiveness
**Capital Controls**: Limits spillover but creates pressure
...
*The Fed giveth, and the Fed taketh away. The key is knowing which cycle you're in and positioning accordingly.*`,
          author: { 
            ...
            bio: 'Chuyên gia phân tích blockchain với 8+ năm kinh nghiệm. Từng là việc tại các quỹ đầu tư lớn và publish 100+ bài nghiên cứu về crypto.',
            verified: true
          },
